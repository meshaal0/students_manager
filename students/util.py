...
def get_absent_students_today():
    ...
    absent_for_report = {s.id: s for s in summary['absent_students'] + summary['unmarked_students']}.values()
...
def get_students_with_overdue_payments(branch_id=None):
    """
...
def get_attendance_trends(start_date, end_date, period='day',branch_id=None):
    """
